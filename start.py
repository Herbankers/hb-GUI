...
class Ui_main(object):
    ...
    def setupUi(self, main):
        ...
        self.languages.addItem("")
        self.languages.addItem("")
        self.languages.setGeometry(QtCore.QRect(1710, 0, 200, 50))
    ...
    def retranslateUi(self, main):
        ...
        self.languages.setItemText(0,_translate("main", "Nederlands/Dutch"))
        self.languages.setItemText(1,_translate("main", "English/Engels"))
        self.languages.setItemText(2,_translate("main", "Deutsch/Duits"))
